...
case 2:this.$=c[b-2]+c[b];break;case 3:this.$=c[b-2]-c[b];break;case 4:this.$=c[b-2]*c[b];break;case 5:this.$=c[b-2]/c[b];break;case 6:this.$=Math.pow(c[b-2],c[b]);break;case 7:this.$=function t(a){return 0==a?1:t(a-1)*a}(c[b-1]);break;case 8:this.$=c[b-1]/100;break;case 9:this.$=-c[b];break;case 10:this.$=c[b-1];break;case 11:this.$=Number(a);break;case 12:this.$=Math.E;break;case 13:this.$=Math.PI}},table:[{3:1,4:2,7:[1,3],13:[1,4],15:[1,5],16:[1,6],17:[1,7]},{1:[3]},{5:[1,8],6:[1,9],7:[1,10],8:[1,
11],9:[1,12],10:[1,13],11:[1,14],12:[1,15]},{4:16,7:[1,3],13:[1,4],15:[1,5],16:[1,6],17:[1,7]},{4:17,7:[1,3],13:[1,4],15:[1,5],16:[1,6],17:[1,7]},{5:[2,11],6:[2,11],7:[2,11],8:[2,11],9:[2,11],10:[2,11],11:[2,11],12:[2,11],14:[2,11]},{5:[2,12],6:[2,12],7:[2,12],8:[2,12],9:[2,12],10:[2,12],11:[2,12],12:[2,12],14:[2,12]},{5:[2,13],6:[2,13],7:[2,13],8:[2,13],9:[2,13],10:[2,13],11:[2,13],12:[2,13],14:[2,13]},{1:[2,1]},{4:18,7:[1,3],13:[1,4],15:[1,5],16:[1,6],17:[1,7]},{4:19,7:[1,3],13:[1,4],15:[1,5],16:[1,
6],17:[1,7]},{4:20,7:[1,3],13:[1,4],15:[1,5],16:[1,6],17:[1,7]},{4:21,7:[1,3],13:[1,4],15:[1,5],16:[1,6],17:[1,7]},{4:22,7:[1,3],13:[1,4],15:[1,5],16:[1,6],17:[1,7]},{5:[2,7],6:[2,7],7:[2,7],8:[2,7],9:[2,7],10:[2,7],11:[2,7],12:[2,7],14:[2,7]},{5:[2,8],6:[2,8],7:[2,8],8:[2,8],9:[2,8],10:[2,8],11:[2,8],12:[2,8],14:[2,8]},{5:[2,9],6:[2,9],7:[2,9],8:[2,9],9:[2,9],10:[2,9],11:[2,9],12:[2,9],14:[2,9]},{6:[1,9],7:[1,10],8:[1,11],9:[1,12],10:[1,13],11:[1,14],12:[1,15],14:[1,23]},{5:[2,2],6:[2,2],7:[2,2],
8:[1,11],9:[1,12],10:[1,13],11:[1,14],12:[1,15],14:[2,2]},{5:[2,3],6:[2,3],7:[2,3],8:[1,11],9:[1,12],10:[1,13],11:[1,14],12:[1,15],14:[2,3]},{5:[2,4],6:[2,4],7:[2,4],8:[2,4],9:[2,4],10:[1,13],11:[1,14],12:[1,15],14:[2,4]},{5:[2,5],6:[2,5],7:[2,5],8:[2,5],9:[2,5],10:[1,13],11:[1,14],12:[1,15],14:[2,5]},{5:[2,6],6:[2,6],7:[2,6],8:[2,6],9:[2,6],10:[2,6],11:[1,14],12:[1,15],14:[2,6]},{5:[2,10],6:[2,10],7:[2,10],8:[2,10],9:[2,10],10:[2,10],11:[2,10],12:[2,10],14:[2,10]}],defaultActions:{8:[2,1]},parseError:function(a){throw Error(a);
},parse:function(a){function b(){var a;a=e.lexer.lex()||1;"number"!==typeof a&&(a=e.symbols_[a]||a);return a}var e=this,d=[0],g=[null],c=[],m=this.table,j="",n=0,s=0,o=0;this.lexer.setInput(a);this.lexer.yy=this.yy;this.yy.lexer=this.lexer;"undefined"==typeof this.lexer.yylloc&&(this.lexer.yylloc={});a=this.lexer.yylloc;c.push(a);"function"===typeof this.yy.parseError&&(this.parseError=this.yy.parseError);for(var f,k,h,i,p={},q,l;;){h=d[d.length-1];this.defaultActions[h]?i=this.defaultActions[h]:
(null==f&&(f=b()),i=m[h]&&m[h][f]);if("undefined"===typeof i||!i.length||!i[0]){if(!o){k=[];for(q in m[h])this.terminals_[q]&&2<q&&k.push("'"+this.terminals_[q]+"'");var r="",r=this.lexer.showPosition?"Parse error on line "+(n+1)+":\n"+this.lexer.showPosition()+"\nExpecting "+k.join(", ")+", got '"+this.terminals_[f]+"'":"Parse error on line "+(n+1)+": Unexpected "+(1==f?"end of input":"'"+(this.terminals_[f]||f)+"'");this.parseError(r,{text:this.lexer.match,token:this.terminals_[f]||f,line:this.lexer.yylineno,
loc:a,expected:k})}if(3==o){if(1==f)throw Error(r||"Parsing halted.");s=this.lexer.yyleng;j=this.lexer.yytext;n=this.lexer.yylineno;a=this.lexer.yylloc;f=b()}for(;!((2).toString()in m[h]);){if(0==h)throw Error(r||"Parsing halted.");d.length-=2;g.length-=1;c.length-=1;h=d[d.length-1]}k=f;f=2;h=d[d.length-1];i=m[h]&&m[h][2];o=3}if(i[0]instanceof Array&&1<i.length)throw Error("Parse Error: multiple actions possible at state: "+h+", token: "+f);switch(i[0]){case 1:d.push(f);g.push(this.lexer.yytext);
c.push(this.lexer.yylloc);d.push(i[1]);f=null;k?(f=k,k=null):(s=this.lexer.yyleng,j=this.lexer.yytext,n=this.lexer.yylineno,a=this.lexer.yylloc,0<o&&o--);break;case 2:l=this.productions_[i[1]][1];p.$=g[g.length-l];p._$={first_line:c[c.length-(l||1)].first_line,last_line:c[c.length-1].last_line,first_column:c[c.length-(l||1)].first_column,last_column:c[c.length-1].last_column};h=this.performAction.call(p,j,s,n,this.yy,i[1],g,c);if("undefined"!==typeof h)return h;l&&(d=d.slice(0,-2*l),g=g.slice(0,-1*
l),c=c.slice(0,-1*l));d.push(this.productions_[i[1]][0]);g.push(p.$);c.push(p._$);i=m[d[d.length-2]][d[d.length-1]];d.push(i);break;case 3:return!0}}return!0}},j=function(){return{EOF:1,parseError:function(a,b){if(this.yy.parseError)this.yy.parseError(a,b);else throw Error(a);},setInput:function(a){this._input=a;this._more=this._less=this.done=!1;this.yylineno=this.yyleng=0;this.yytext=this.matched=this.match="";this.conditionStack=["INITIAL"];this.yylloc={first_line:1,first_column:0,last_line:1,
last_column:0};return this},input:function(){var a=this._input[0];this.yytext+=a;this.yyleng++;this.match+=a;this.matched+=a;a.match(/\n/)&&this.yylineno++;this._input=this._input.slice(1);return a},unput:function(a){this._input=a+this._input;return this},more:function(){this._more=!0;return this},less:function(a){this._input=this.match.slice(a)+this._input},pastInput:function(){var a=this.matched.substr(0,this.matched.length-this.match.length);return(20<a.length?"...":"")+a.substr(-20).replace(/\n/g,
